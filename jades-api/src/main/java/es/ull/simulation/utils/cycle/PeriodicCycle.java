...
public class PeriodicCycle extends Cycle {
  ...
  protected final AbstractTimeFunction period;
   ...
   */
  public PeriodicCycle(double startTs, AbstractTimeFunction period, double endTs) {
    super();
   ...
   * infinite iterations.
   */
  public PeriodicCycle(double startTs, AbstractTimeFunction period, int iterations) {
    super();
    this.startTs = startTs;
    this.period = period;
   ...
   */
  public PeriodicCycle(double startTs, AbstractTimeFunction period, double endTs, Cycle subCycle) {
    super(subCycle);
    this.startTs = startTs;
    this.period = period;
    this.endTs = endTs;
   ...
   * @param subCycle Subcycle contained in this cycle.
   */
  public PeriodicCycle(double startTs, AbstractTimeFunction period, int iterations, Cycle subCycle) {
    super(subCycle);
    this.startTs = startTs;
    this.period = period;
    this.iterations = iterations;
   ...
   */
  public AbstractTimeFunction getPeriod() {
    return period;
  }
