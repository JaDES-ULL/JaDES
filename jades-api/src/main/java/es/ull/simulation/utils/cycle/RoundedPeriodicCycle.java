...
import es.ull.simulation.utils.ExtendedMath;
...
public class RoundedPeriodicCycle extends PeriodicCycle {
   ...
   */
  public RoundedPeriodicCycle(double startTs, AbstractTimeFunction period,
                              double endTs, Type type, double scale) {
   ...
   */
  public RoundedPeriodicCycle(double startTs, AbstractTimeFunction period,
                              int iterations, Type type, double scale) {
   ...
   */
  public RoundedPeriodicCycle(double startTs, AbstractTimeFunction period,
                              double endTs, Cycle subCycle, Type type, double scale) {
   ...
   */
  public RoundedPeriodicCycle(double startTs, AbstractTimeFunction period,
                              int iterations, Cycle subCycle, Type type, double scale) {
   ...
   */
  public RoundedPeriodicCycle(double startTs, AbstractTimeFunction period,
                              double endTs, Type type, double scale, double shift) {
   ...
   */
  public RoundedPeriodicCycle(double startTs, AbstractTimeFunction period,
                              int iterations, Type type, double scale, double shift) {
   ...
   */
  public RoundedPeriodicCycle(double startTs, AbstractTimeFunction period,
                              double endTs, Cycle subCycle, Type type, double scale, double shift) {
   ...
   */
  public RoundedPeriodicCycle(double startTs, AbstractTimeFunction period,
                              int iterations, Cycle subCycle, Type type,
   ...
   * @author Iv8n Castilla Rodrdguez
   */
  protected class RoundedPeriodicIteratorLevel extends PeriodicIteratorLevel {
    /**
   ...
   * @author Iv8n Castilla Rodrdguez
   */
  protected class RoundedPeriodicDiscreteIteratorLevel
      extends PeriodicDiscreteIteratorLevel {
    /**
     * @param start The start timestamp.
     * @param end The end timestamp.
     */
