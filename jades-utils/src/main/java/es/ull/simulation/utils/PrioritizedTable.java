...
public class PrioritizedTable<E extends Prioritizable>
  ...
  private class BalancedIterator implements Iterator<E> {
    ...
    /** Number of objects of the level. This value is used for determining when the iterator has
    ...
    /**
     * Returns the next object of the prioritized map. This method makes use of the previously
     * chosen object of a level. Thus, every time this method starts a level, it's started at a
     * different point.
