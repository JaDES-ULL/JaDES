...
public class OntologyRefactoring {
    ...
    private OWLClassExpression replaceMin0InExpression(OWLClassExpression expr, OWLDataFactory factory) {
        // Si es una restricci├│n de min cardinality
        ...
        // Si es una intersecci├│n, se procesa recursivamente cada operando
        ...
        // Si es uni├│n, complemento, etc., se puede extender de forma similar
