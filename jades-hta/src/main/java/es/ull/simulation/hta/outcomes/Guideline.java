...
import es.ull.simulation.hta.progression.DiseaseProgressionPathway.ConditionInformation;
...
public class Guideline implements NamedAndDescribed {
	 ...
	 * 
	 */
	public Guideline(HTAModel model, String name, String description, AbstractCondition<ConditionInformation> condition) {
		this.model = model;
		this.name = name;
