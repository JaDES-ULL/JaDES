...
public abstract class TabularParameter<K extends Comparable<K>> extends Parameter {
     ...
     */
    public TabularParameter(HTAModel model, String name, String description, String source, int year, ParameterGroup group, Map<K, Double> table) {
     ...
     * @param name The unique name of the parameter
     */
    public TabularParameter(HTAModel model, String name, String description, String source, int year, ParameterGroup group) {
        super(model, name, description, source, year, group);
