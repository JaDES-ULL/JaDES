 ...
 * 
 */
package es.ull.simulation.hta.info;
 ...
 * progression of the disease should emit these pieces of information to be collected by the corresponding {@link BasicListener}
 * @author Iván Castilla Rodríguez
 *
 */
public class PatientInfo extends SimulationInfo {
