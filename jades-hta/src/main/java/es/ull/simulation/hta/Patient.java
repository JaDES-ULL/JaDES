...
import es.ull.simulation.hta.progression.DiseaseProgressionEventPair;
...
import es.ull.simulation.model.VariableStoreSimulationObject;
 ...
 *
 */
public class Patient extends VariableStoreSimulationObject implements IEventSource {
	...
	private class StartEvent extends DiscreteEvent.DefaultStartEvent {
		...
		public StartEvent(IEventSource source, long ts) {
			super(source, ts);
		}
