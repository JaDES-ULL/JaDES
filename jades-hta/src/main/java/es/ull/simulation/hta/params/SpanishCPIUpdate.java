 ...
 * Currently updated up to the 2025 CPI. Future uses require adding extra values to both GENERAL_INDEX and HEALTHCARE_INDEX
 * Source: https://www.ine.es/jaxiT3/Tabla.htm?t=50902&L=0
 * @author Iván Castilla Rodríguez
 *
 */
public class SpanishCPIUpdate {
	/** Last year that we have collected data */
	final static private int LAST_YEAR = 2025;
	/** General indexes for the Spanish CPI, taken from January. The last value corresponds to the last (most updated) year */
	final static private double[] GENERAL_INDEX = {69.53, 72.111, 73.773, 76.046, 79.234, 81.129, 84.598, 85.281, 86.158, 88.975, 90.753, 93.188, 93.373, 92.141, 91.876, 94.609, 95.153, 96.085, 97.139, 97.583, 103.567, 109.668, 113.404, 116.733};
	final static private double[] HEALTHCARE_INDEX = {86.313, 88.385, 90.115, 90.337, 90.946, 92.417, 90.668, 90.732, 89.542, 88.267, 85.699, 96.032, 97.271, 97.175, 96.828, 97.551, 97.848, 98.694, 99.149, 99.62, 100.5, 101.743, 103.942, 106.028};
