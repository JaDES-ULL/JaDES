...
import es.ull.simulation.hta.diab.interventions.DCCT_ConventionalIntervention;
import es.ull.simulation.hta.diab.interventions.DCCT_IntensiveIntervention;
...
public class T1DMModel extends HTAModel {
	...
	public T1DMModel(HTAExperiment experiment, ModelConfig config) throws MalformedSimulationModelException {
		super(experiment);
