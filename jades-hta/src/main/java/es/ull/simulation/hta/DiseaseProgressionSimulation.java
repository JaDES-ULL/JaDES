...
public class DiseaseProgressionSimulation extends Simulation {
	 ...
	 */
	public DiseaseProgressionSimulation(int id, Intervention intervention, HTAModel model) {
		super(id, DESCRIPTION + " " + intervention.getDescription(), model.getSimulationTimeUnit());
		this.model = model;
		this.cloned = false;
		this.intervention = intervention;
		this.nPatients = model.getNPatients();
	...
	public DiseaseProgressionSimulation(DiseaseProgressionSimulation original, Intervention intervention) {
		super(original.id, original.description + " " + intervention.getDescription(), original.getTimeUnit());
		this.cloned = true;
		this.intervention = intervention;
