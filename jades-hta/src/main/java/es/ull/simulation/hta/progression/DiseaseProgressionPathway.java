 ...
 * 
 */
package es.ull.simulation.hta.progression;
...
/**
 * A "pathway" to a manifestation. Pathways consists of a {@link AbstractCondition condition} that must be met by the patient and a way of computing the 
...
public class DiseaseProgressionPathway extends HTAModelComponent {
	...
	/** AbstractCondition that must be met progress to a manifestation */
	private final AbstractCondition<ConditionInformation> condition;
	 ...
	 */
	public DiseaseProgressionPathway(HTAModel model, String name, String description, DiseaseProgression nextProgression, TimeToEventCalculator tteCalculator, AbstractCondition<ConditionInformation> condition) {
	 ...
	 */
	public AbstractCondition<ConditionInformation> getCondition() {
		return condition;
	}
