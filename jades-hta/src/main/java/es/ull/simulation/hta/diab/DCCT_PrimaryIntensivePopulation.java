...
import es.ull.simulation.hta.populations.FirstOrderOnlyPopulation;
...
public class DCCT_PrimaryIntensivePopulation extends FirstOrderOnlyPopulation {
	...
	public void createParameters() {
		if (T1DMDisease.FIXED_BASE_VALUES) {
			model.addParameter(new ConstantNatureParameter(getModel(), T1DMModel.STR_HBA1C, "", "", ParameterGroup.ATTRIBUTE, BASELINE_HBA1C_AVG));
			model.addParameter(new ConstantNatureParameter(getModel(), T1DMModel.STR_DURATION, "", "", ParameterGroup.ATTRIBUTE, BASELINE_DURATION_AVG));
		}
		else {
			...
			model.addParameter(new FirstOrderNatureParameter(getModel(), T1DMModel.STR_HBA1C, "", "", 2013, ParameterGroup.ATTRIBUTE, 
					RandomVariateFactory.getInstance("ScaledVariate", rndHbA1c, 1.0, BASELINE_HBA1C_MIN)));
			model.addParameter(new FirstOrderNatureParameter(getModel(), T1DMModel.STR_DURATION, "", "", 2013, ParameterGroup.ATTRIBUTE, 
