...
public class T1DMSimpleTestPopulation extends StdPopulation {
	...
	public void createParameters() {
		model.addParameter(new ConstantNatureParameter(getModel(), T1DMModel.STR_HBA1C, "", "", ParameterGroup.ATTRIBUTE, BASELINE_HBA1C));
		model.addParameter(new ConstantNatureParameter(getModel(), T1DMModel.STR_DURATION, "", "", ParameterGroup.ATTRIBUTE, BASELINE_DURATION));
