 ...
 *
 */
public class ExclusiveChoiceCondition extends AbstractCondition<DiseaseProgressionPathway.ConditionInformation> {
	...
	public ExclusiveChoiceCondition(HTAModel model, Map<DiseaseProgression, String> paramsByProgression) {
		...
		this.selectors = new SingleSelector[model.getNExperiments() + 1];
